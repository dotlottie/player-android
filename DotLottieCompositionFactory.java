...
public class DotLottieCompositionFactory {
    /**
    ...
    private DotLottieCompositionFactory() {
    }
    ...
    public static LottieResult<LottieComposition> fromRawResSync(Context context, @RawRes int rawRes, @Nullable String cacheKey) {
        try {
            if(isZipCompressed(context, rawRes)) {
    ...
    /**
     * attempts to determine if the raw res is a .zip file or not
     */
    private static Boolean isZipCompressed(Context context, @RawRes int rawRes) {
        ...
        try {
            ...
            while (entry != null) {
                ...
                if (entryName.contains("__MACOSX")) {
                    ...
                    composition = DotLottieCompositionFactory.fromJsonReaderSyncInternal(reader, null, false).getValue();
